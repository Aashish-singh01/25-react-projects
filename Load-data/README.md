# 🛒 Load More Products (React)

## 🚀 Overview

This is a dynamic **Load More Products** project built using **React**.
It fetches product data from an API and displays them in a grid layout. Users can load more products by clicking a button.
